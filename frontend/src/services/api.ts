...
export function setAuthToken(t: string | null) { t ? localStorage.setItem('access_token', t) : localStorage.removeItem('access_token'); }
...
export async function loginApi(username: string, password: string): Promise<AuthResponse> {
  ...
  setAuthToken(data.access_token); setStoredUser(data.user); return data;
}
